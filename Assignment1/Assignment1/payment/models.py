...
class Account(models.Model):
    ...
    expiration_month = models.CharField(max_length=50, default="", choices=MONTH_CHOICES)
    expiration_year = models.CharField(max_length=50, default="", choices=YEAR_CHOICES)
