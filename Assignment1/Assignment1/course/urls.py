...
urlpatterns = [
    ...
    path('<int:courseid>/assignment/delete/<int:assignmentid>', views.assignment_delete, name="delete_assignment"),
    path('<int:courseid>/assignment/edit/<int:assignmentid>', views.assignment_edit, name="edit_assignment"),
